...
class TestRunDiff:
    ...
    def test_cluster_diff_json_output(self):
        ...
        result_json = de.run_diff(old_map, new_map, "", "clusters")
    ...
    def test_cluster_added(self):
        ...
        old_map = {}
        new_map = {"OnOff.xml": CLUSTER_WITH_FEATURES_XML}
        result = json.loads(de.run_diff(old_map, new_map, "", "clusters"))
        assert "OnOff.xml" in result["added"]
    ...
    def test_device_type_diff(self):
        ...
        result = json.loads(de.run_diff(old_map, new_map, "", "device_types"))
    ...
    def test_filter_applied(self):
        ...
        result = json.loads(de.run_diff(old_map, new_map, "OnOff", "clusters"))
        assert "OnOff.xml" in result["added"]
    ...
    def test_both_empty_maps(self):
        """ """
        result = json.loads(de.run_diff({}, {}, "", "clusters"))
        assert result["added"] == {}
        assert result["removed"] == {}
    ...
    def test_result_is_valid_json(self):
        ...
        old_map = {"OnOff.xml": CLUSTER_WITH_FEATURES_XML}
        new_map = {"OnOff.xml": CLUSTER_WITH_FEATURES_XML}
        result_str = de.run_diff(old_map, new_map, "", "clusters")
...
class TestRealXmlFiles:
    ...
    def test_diff_adjacent_versions(self, has_data):
        ...
        for cat in ("clusters", "device_types"):
            ...
            result_str = de.run_diff(old_map, new_map, "", cat)
    ...
    def test_diff_with_search_filter(self, has_data):
        ...
        result_str = de.run_diff(old_map, new_map, "OnOff", "clusters")
        result = json.loads(result_str)
        assert isinstance(result, dict)
